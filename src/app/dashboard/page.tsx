      ...
      <div className="min-h-screen bg-[#0b0b0b] relative overflow-hidden pt-16">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="relative overflow-hidden bg-gradient-to-r from-[#00E5A8] via-[#00C090] to-[#00B386] rounded-2xl p-8 text-black mb-8 shadow-xl border border-[#00E5A8]/20">
            ...
            <div className="relative">
              <h2 className="text-3xl font-bold mb-2 drop-shadow-sm font-cinzel">Welcome, {student.studentName}!</h2>
              <p className="text-black/80 font-medium font-cinzel">Class {student.standard} | ID: {student.registrationId}</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-[#111111] rounded-xl shadow-md hover:shadow-lg transition-all p-6 border border-gray-800 hover:border-[#00E5A8]/30 group">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-gray-400 text-sm font-medium mb-1 font-cinzel">Overall Attendance</p>
                  <p className="text-3xl font-bold text-[#00E5A8] font-cinzel">{overallAttendance}%</p>
                </div>
            ...
            <div className="bg-[#111111] rounded-xl shadow-md hover:shadow-lg transition-all p-6 border border-gray-800 hover:border-[#00E5A8]/30 group">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-gray-400 text-sm font-medium mb-1 font-cinzel">Tests Completed</p>
                  <p className="text-3xl font-bold text-[#00E5A8] font-cinzel">{testResults.length}</p>
                </div>
                <div className="p-3 bg-[#00E5A8]/10 rounded-xl group-hover:scale-110 transition-transform">
            ...
            <div className="bg-[#111111] rounded-xl shadow-md hover:shadow-lg transition-all p-6 border border-gray-800 hover:border-[#00E5A8]/30 group">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-gray-400 text-sm font-medium mb-1 font-cinzel">Upcoming Tests</p>
                  <p className="text-3xl font-bold text-[#00E5A8] font-cinzel">{upcomingTests.length}</p>
                </div>
                <div className="p-3 bg-[#00E5A8]/10 rounded-xl group-hover:scale-110 transition-transform">
            ...
            <div className="bg-[#111111] rounded-xl shadow-md hover:shadow-lg transition-all p-6 border border-gray-800 hover:border-[#00E5A8]/30 group">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-gray-400 text-sm font-medium mb-1 font-cinzel">Study Materials</p>
                  <p className="text-3xl font-bold text-white font-cinzel">{studyMaterials.length}</p>
                </div>
                <div className="p-3 bg-[#00E5A8]/10 rounded-xl group-hover:scale-110 transition-transform">
          ...
          <div className="bg-[#111111] rounded-xl shadow-md p-8 border border-gray-800">
            ...
            {activeTab === 'overview' && (
              <div className="space-y-6">
                <div className="bg-[#080808] border border-[#00E5A8]/20 rounded-xl p-6 shadow-sm">
                  <h3 className="font-bold text-white mb-4 flex items-center gap-2 text-lg font-cinzel">
            ...
            {activeTab === 'attendance' && (
              <div>
                <h3 className="text-lg font-bold mb-4 text-white font-cinzel">Subject-wise Attendance</h3>
                {attendance.length > 0 ? (
