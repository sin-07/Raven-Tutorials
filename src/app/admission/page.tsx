    ...
    <div className="min-h-screen bg-[#0b0b0b] relative overflow-hidden flex items-center justify-center p-4 pt-24">
      ...
      <div className="relative z-10 max-w-4xl w-full">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold text-white mb-4 font-cinzel">Join <span className="text-[#00E5A8]">Raven Tutorials</span></h1>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          ...
          <div className="bg-[#111111] rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all border-2 border-gray-800 hover:border-[#00E5A8]/30">
            ...
            <h2 className="text-2xl font-bold text-white mb-4 text-center font-cinzel">Admission as a Learner</h2>
            <p className="text-gray-400 mb-6 text-center font-cinzel">
              Join as a student to access expert courses, live classes, and personalized learning paths.
            </p>
            
            <ul className="space-y-3 mb-8 font-cinzel">
          ...
          <div className="bg-[#111111] rounded-2xl shadow-xl p-8 hover:shadow-2xl transition-all border-2 border-gray-800 hover:border-[#00E5A8]/30">
            ...
            <h2 className="text-2xl font-bold text-white mb-4 text-center font-cinzel">Admission as a Tutor</h2>
            <p className="text-gray-400 mb-6 text-center font-cinzel">
